...
package ltpi_csr_light_pkg;
    ...
    typedef struct {
        logic next;
    } ltpi_csr_light__LTPI_Link_Status__link_lost_error__in_t;

    typedef struct {
        logic next;
    } ltpi_csr_light__LTPI_Link_Status__frm_CRC_error__in_t;

    typedef struct {
        logic next;
    } ltpi_csr_light__LTPI_Link_Status__unknown_comma_error__in_t;

    typedef struct {
        logic next;
    } ltpi_csr_light__LTPI_Link_Status__link_speed_timeout_error__in_t;

    typedef struct {
        logic next;
    } ltpi_csr_light__LTPI_Link_Status__link_cfg_acpt_timeout_error__in_t;

    typedef struct {
        logic next;
    } ltpi_csr_light__LTPI_Link_Status__DDR_mode__in_t;

    typedef struct {
        logic [3:0] next;
    } ltpi_csr_light__LTPI_Link_Status__link_speed__in_t;

    typedef struct {
        logic [3:0] next;
    } ltpi_csr_light__LTPI_Link_Status__remote_link_state__in_t;

    typedef struct {
        logic [3:0] next;
    } ltpi_csr_light__LTPI_Link_Status__local_link_state__in_t;

    typedef struct {
        ltpi_csr_light__LTPI_Link_Status__aligned__in_t aligned;
        ltpi_csr_light__LTPI_Link_Status__link_lost_error__in_t link_lost_error;
        ltpi_csr_light__LTPI_Link_Status__frm_CRC_error__in_t frm_CRC_error;
        ltpi_csr_light__LTPI_Link_Status__unknown_comma_error__in_t unknown_comma_error;
        ltpi_csr_light__LTPI_Link_Status__link_speed_timeout_error__in_t link_speed_timeout_error;
        ltpi_csr_light__LTPI_Link_Status__link_cfg_acpt_timeout_error__in_t link_cfg_acpt_timeout_error;
        ltpi_csr_light__LTPI_Link_Status__DDR_mode__in_t DDR_mode;
        ltpi_csr_light__LTPI_Link_Status__link_speed__in_t link_speed;
        ltpi_csr_light__LTPI_Link_Status__remote_link_state__in_t remote_link_state;
        ltpi_csr_light__LTPI_Link_Status__local_link_state__in_t local_link_state;
    } ltpi_csr_light__LTPI_Link_Status__in_t;
    ...
    typedef struct {
        logic [4:0] next;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__supported_channel__in_t;

    typedef struct {
        logic [9:0] next;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__NL_GPIO_nb__in_t;

    typedef struct {
        logic [5:0] next;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__I2C_channel_en__in_t;

    typedef struct {
        logic next;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__I2C_channel_echo_support__in_t;

    typedef struct {
        ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__supported_channel__in_t supported_channel;
        ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__NL_GPIO_nb__in_t NL_GPIO_nb;
        ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__I2C_channel_en__in_t I2C_channel_en;
        ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__I2C_channel_echo_support__in_t I2C_channel_echo_support;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__in_t;

    typedef struct {
        logic [5:0] next;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_HIGH__I2C_channel_speed__in_t;

    typedef struct {
        logic [6:0] next;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_HIGH__UART_channel_cpbl__in_t;

    typedef struct {
        logic [15:0] next;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_HIGH__OEM_capab__in_t;

    typedef struct {
        ltpi_csr_light__LTPI_Advertise_Capab_local_HIGH__I2C_channel_speed__in_t I2C_channel_speed;
        ltpi_csr_light__LTPI_Advertise_Capab_local_HIGH__UART_channel_cpbl__in_t UART_channel_cpbl;
        ltpi_csr_light__LTPI_Advertise_Capab_local_HIGH__OEM_capab__in_t OEM_capab;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_HIGH__in_t;

    typedef struct {
        logic [4:0] next;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__supported_channel__in_t;

    typedef struct {
        logic [9:0] next;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__NL_GPIO_nb__in_t;

    typedef struct {
        logic [5:0] next;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__I2C_channel_en__in_t;

    typedef struct {
        logic next;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__I2C_channel_echo_support__in_t;

    typedef struct {
        ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__supported_channel__in_t supported_channel;
        ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__NL_GPIO_nb__in_t NL_GPIO_nb;
        ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__I2C_channel_en__in_t I2C_channel_en;
        ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__I2C_channel_echo_support__in_t I2C_channel_echo_support;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__in_t;

    typedef struct {
        logic [5:0] next;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_HIGH__I2C_channel_speed__in_t;

    typedef struct {
        logic [6:0] next;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_HIGH__UART_channel_cpbl__in_t;

    typedef struct {
        logic [15:0] next;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_HIGH__OEM_capab__in_t;

    typedef struct {
        ltpi_csr_light__LTPI_Advertise_Capab_remote_HIGH__I2C_channel_speed__in_t I2C_channel_speed;
        ltpi_csr_light__LTPI_Advertise_Capab_remote_HIGH__UART_channel_cpbl__in_t UART_channel_cpbl;
        ltpi_csr_light__LTPI_Advertise_Capab_remote_HIGH__OEM_capab__in_t OEM_capab;
    ...
    typedef struct {
        logic value;
    } ltpi_csr_light__LTPI_Link_Status__aligned__out_t;

    typedef struct {
        logic value;
    } ltpi_csr_light__LTPI_Link_Status__link_lost_error__out_t;

    typedef struct {
        logic value;
    } ltpi_csr_light__LTPI_Link_Status__frm_CRC_error__out_t;

    typedef struct {
        logic value;
    } ltpi_csr_light__LTPI_Link_Status__unknown_comma_error__out_t;

    typedef struct {
        logic value;
    } ltpi_csr_light__LTPI_Link_Status__link_speed_timeout_error__out_t;

    typedef struct {
        logic value;
    } ltpi_csr_light__LTPI_Link_Status__link_cfg_acpt_timeout_error__out_t;

    typedef struct {
        logic value;
    } ltpi_csr_light__LTPI_Link_Status__DDR_mode__out_t;

    typedef struct {
        logic [3:0] value;
    } ltpi_csr_light__LTPI_Link_Status__link_speed__out_t;

    typedef struct {
        logic [3:0] value;
    } ltpi_csr_light__LTPI_Link_Status__remote_link_state__out_t;

    typedef struct {
        logic [3:0] value;
    } ltpi_csr_light__LTPI_Link_Status__local_link_state__out_t;

    typedef struct {
        ltpi_csr_light__LTPI_Link_Status__aligned__out_t aligned;
        ltpi_csr_light__LTPI_Link_Status__link_lost_error__out_t link_lost_error;
        ltpi_csr_light__LTPI_Link_Status__frm_CRC_error__out_t frm_CRC_error;
        ltpi_csr_light__LTPI_Link_Status__unknown_comma_error__out_t unknown_comma_error;
        ltpi_csr_light__LTPI_Link_Status__link_speed_timeout_error__out_t link_speed_timeout_error;
        ltpi_csr_light__LTPI_Link_Status__link_cfg_acpt_timeout_error__out_t link_cfg_acpt_timeout_error;
        ltpi_csr_light__LTPI_Link_Status__DDR_mode__out_t DDR_mode;
        ltpi_csr_light__LTPI_Link_Status__link_speed__out_t link_speed;
        ltpi_csr_light__LTPI_Link_Status__remote_link_state__out_t remote_link_state;
        ltpi_csr_light__LTPI_Link_Status__local_link_state__out_t local_link_state;
    } ltpi_csr_light__LTPI_Link_Status__out_t;
    ...
    typedef struct {
        logic [15:0] value;
    } ltpi_csr_light__LTPI_platform_ID_local__platform_ID_local__out_t;

    typedef struct {
        ltpi_csr_light__LTPI_platform_ID_local__platform_ID_local__out_t platform_ID_local;
    } ltpi_csr_light__LTPI_platform_ID_local__out_t;

    typedef struct {
        logic [4:0] value;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__supported_channel__out_t;

    typedef struct {
        logic [9:0] value;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__NL_GPIO_nb__out_t;

    typedef struct {
        logic [5:0] value;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__I2C_channel_en__out_t;

    typedef struct {
        logic value;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__I2C_channel_echo_support__out_t;

    typedef struct {
        ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__supported_channel__out_t supported_channel;
        ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__NL_GPIO_nb__out_t NL_GPIO_nb;
        ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__I2C_channel_en__out_t I2C_channel_en;
        ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__I2C_channel_echo_support__out_t I2C_channel_echo_support;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__out_t;

    typedef struct {
        logic [5:0] value;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_HIGH__I2C_channel_speed__out_t;

    typedef struct {
        logic [6:0] value;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_HIGH__UART_channel_cpbl__out_t;

    typedef struct {
        logic [15:0] value;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_HIGH__OEM_capab__out_t;

    typedef struct {
        ltpi_csr_light__LTPI_Advertise_Capab_local_HIGH__I2C_channel_speed__out_t I2C_channel_speed;
        ltpi_csr_light__LTPI_Advertise_Capab_local_HIGH__UART_channel_cpbl__out_t UART_channel_cpbl;
        ltpi_csr_light__LTPI_Advertise_Capab_local_HIGH__OEM_capab__out_t OEM_capab;
    } ltpi_csr_light__LTPI_Advertise_Capab_local_HIGH__out_t;

    typedef struct {
        logic [4:0] value;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__supported_channel__out_t;

    typedef struct {
        logic [9:0] value;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__NL_GPIO_nb__out_t;

    typedef struct {
        logic [5:0] value;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__I2C_channel_en__out_t;

    typedef struct {
        logic value;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__I2C_channel_echo_support__out_t;

    typedef struct {
        ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__supported_channel__out_t supported_channel;
        ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__NL_GPIO_nb__out_t NL_GPIO_nb;
        ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__I2C_channel_en__out_t I2C_channel_en;
        ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__I2C_channel_echo_support__out_t I2C_channel_echo_support;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__out_t;

    typedef struct {
        logic [5:0] value;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_HIGH__I2C_channel_speed__out_t;

    typedef struct {
        logic [6:0] value;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_HIGH__UART_channel_cpbl__out_t;

    typedef struct {
        logic [15:0] value;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_HIGH__OEM_capab__out_t;

    typedef struct {
        ltpi_csr_light__LTPI_Advertise_Capab_remote_HIGH__I2C_channel_speed__out_t I2C_channel_speed;
        ltpi_csr_light__LTPI_Advertise_Capab_remote_HIGH__UART_channel_cpbl__out_t UART_channel_cpbl;
        ltpi_csr_light__LTPI_Advertise_Capab_remote_HIGH__OEM_capab__out_t OEM_capab;
    } ltpi_csr_light__LTPI_Advertise_Capab_remote_HIGH__out_t;

    typedef struct {
        logic [4:0] value;
    } ltpi_csr_light__LTPI_Config_Capab_LOW__supported_channel__out_t;

    typedef struct {
        logic [9:0] value;
    } ltpi_csr_light__LTPI_Config_Capab_LOW__NL_GPIO_nb__out_t;

    typedef struct {
        logic [5:0] value;
    } ltpi_csr_light__LTPI_Config_Capab_LOW__I2C_channel_en__out_t;

    typedef struct {
        logic value;
    } ltpi_csr_light__LTPI_Config_Capab_LOW__I2C_channel_echo_support__out_t;

    typedef struct {
        ltpi_csr_light__LTPI_Config_Capab_LOW__supported_channel__out_t supported_channel;
        ltpi_csr_light__LTPI_Config_Capab_LOW__NL_GPIO_nb__out_t NL_GPIO_nb;
        ltpi_csr_light__LTPI_Config_Capab_LOW__I2C_channel_en__out_t I2C_channel_en;
        ltpi_csr_light__LTPI_Config_Capab_LOW__I2C_channel_echo_support__out_t I2C_channel_echo_support;
    } ltpi_csr_light__LTPI_Config_Capab_LOW__out_t;

    typedef struct {
        logic [5:0] value;
    } ltpi_csr_light__LTPI_Config_Capab_HIGH__I2C_channel_speed__out_t;

    typedef struct {
        logic [6:0] value;
    } ltpi_csr_light__LTPI_Config_Capab_HIGH__UART_channel_cpbl__out_t;

    typedef struct {
        logic [15:0] value;
    } ltpi_csr_light__LTPI_Config_Capab_HIGH__OEM_capab__out_t;

    typedef struct {
        ltpi_csr_light__LTPI_Config_Capab_HIGH__I2C_channel_speed__out_t I2C_channel_speed;
        ltpi_csr_light__LTPI_Config_Capab_HIGH__UART_channel_cpbl__out_t UART_channel_cpbl;
        ltpi_csr_light__LTPI_Config_Capab_HIGH__OEM_capab__out_t OEM_capab;
    } ltpi_csr_light__LTPI_Config_Capab_HIGH__out_t;

    typedef struct {
        logic value;
    } ltpi_csr_light__LTPI_Link_Ctrl__software_reset__out_t;

    typedef struct {
        logic value;
    } ltpi_csr_light__LTPI_Link_Ctrl__retraining_req__out_t;

    typedef struct {
        logic [6:0] value;
    } ltpi_csr_light__LTPI_Link_Ctrl__I2C_channel_reset__out_t;

    typedef struct {
        logic value;
    } ltpi_csr_light__LTPI_Link_Ctrl__data_channel_reset__out_t;

    typedef struct {
        logic value;
    } ltpi_csr_light__LTPI_Link_Ctrl__auto_move_config__out_t;

    typedef struct {
        logic value;
    } ltpi_csr_light__LTPI_Link_Ctrl__trigger_config_st__out_t;

    typedef struct {
        ltpi_csr_light__LTPI_Link_Ctrl__software_reset__out_t software_reset;
        ltpi_csr_light__LTPI_Link_Ctrl__retraining_req__out_t retraining_req;
        ltpi_csr_light__LTPI_Link_Ctrl__I2C_channel_reset__out_t I2C_channel_reset;
        ltpi_csr_light__LTPI_Link_Ctrl__data_channel_reset__out_t data_channel_reset;
        ltpi_csr_light__LTPI_Link_Ctrl__auto_move_config__out_t auto_move_config;
        ltpi_csr_light__LTPI_Link_Ctrl__trigger_config_st__out_t trigger_config_st;
    ...
    typedef struct {
        ...
        ltpi_csr_light__LTPI_platform_ID_local__out_t LTPI_platform_ID_local;
        ltpi_csr_light__LTPI_Advertise_Capab_local_LOW__out_t LTPI_Advertise_Capab_local_LOW;
        ltpi_csr_light__LTPI_Advertise_Capab_local_HIGH__out_t LTPI_Advertise_Capab_local_HIGH;
        ltpi_csr_light__LTPI_Advertise_Capab_remote_LOW__out_t LTPI_Advertise_Capab_remote_LOW;
        ltpi_csr_light__LTPI_Advertise_Capab_remote_HIGH__out_t LTPI_Advertise_Capab_remote_HIGH;
