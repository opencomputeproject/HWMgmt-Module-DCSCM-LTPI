...
package ltpi_csr_pkg;
    ...
    localparam LTPI_CSR_DATA_WIDTH = 32;
    localparam LTPI_CSR_MIN_ADDR_WIDTH = 8;
    localparam LTPI_CSR_SIZE = 'h84;
    ...
    typedef struct {
        logic [3:0] next;
    } ltpi_csr__LTPI_Detect_Capabilities_Remote__remote_Minor_Revision__in_t;

    typedef struct {
        logic [3:0] next;
    } ltpi_csr__LTPI_Detect_Capabilities_Remote__remote_Major_Revision__in_t;
    ...
    typedef struct {
        ltpi_csr__LTPI_Detect_Capabilities_Remote__remote_Minor_Revision__in_t remote_Minor_Revision;
        ltpi_csr__LTPI_Detect_Capabilities_Remote__remote_Major_Revision__in_t remote_Major_Revision;
    ...
    typedef struct {
        logic [3:0] value;
    } ltpi_csr__LTPI_Detect_Capabilities_Local__local_Minor_Revision__out_t;

    typedef struct {
        logic [3:0] value;
    } ltpi_csr__LTPI_Detect_Capabilities_Local__local_Major_Revision__out_t;
    ...
    typedef struct {
        ltpi_csr__LTPI_Detect_Capabilities_Local__local_Minor_Revision__out_t local_Minor_Revision;
        ltpi_csr__LTPI_Detect_Capabilities_Local__local_Major_Revision__out_t local_Major_Revision;
    ...
    typedef struct {
        logic [3:0] value;
    } ltpi_csr__LTPI_Detect_Capabilities_Remote__remote_Minor_Revision__out_t;

    typedef struct {
        logic [3:0] value;
    } ltpi_csr__LTPI_Detect_Capabilities_Remote__remote_Major_Revision__out_t;
    ...
    typedef struct {
        ltpi_csr__LTPI_Detect_Capabilities_Remote__remote_Minor_Revision__out_t remote_Minor_Revision;
        ltpi_csr__LTPI_Detect_Capabilities_Remote__remote_Major_Revision__out_t remote_Major_Revision;
